...
function TitleView:new(layoutWidth, layoutHeight)
	...
	function view:init()
		local field = display.newText("Simple eating tips to be a healthier person.", 0, 0, native.systemFont, 21)
		...
		local titleField = display.newText("Health Katas", 0, 0, TEXT_WIDTH, 28, native.systemFont, 28)
